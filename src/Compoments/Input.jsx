...
function Input() {
  ...
  return (
    <>
      <div className="flex justify-between gap-5 flex-col w-[50%]">
        ...
        <div className="w-full">
          ...
          <br />
          <input
            className="bg-white border border-blue-500 rounded-lg w-full mt-4 py-2 px-3"
            type="number"
            name=""
            id="cost"
            ref={number}
      ...
      <button
        className="py-2 px-8 text-lg font-medium bg-blue-600 mt-4 text-white rounded"
